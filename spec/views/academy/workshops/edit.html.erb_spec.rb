...
describe "academy/workshops/edit" do
  before(:each) do
  ...
  it "renders the edit academy_workshop form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", academy_workshop_path(@academy_workshop), "post" do

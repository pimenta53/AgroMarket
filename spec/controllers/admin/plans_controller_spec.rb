...
describe Admin::PlansController do
  ...
  describe "GET index" do
    it "assigns all admin_plans as @admin_plans" do
      plan = Admin::Plan.create! valid_attributes
      get :index, {}, valid_session
      assigns(:admin_plans).should eq([plan])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested admin_plan as @admin_plan" do
      ...
      assigns(:admin_plan).should eq(plan)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin_plan as @admin_plan" do
      ...
      assigns(:admin_plan).should be_a_new(Admin::Plan)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Admin::Plan" do
        ...
        }.to change(Admin::Plan, :count).by(1)
      end

      it "assigns a newly created admin_plan as @admin_plan" do
        post :create, {:admin_plan => valid_attributes}, valid_session
        assigns(:admin_plan).should be_a(Admin::Plan)
        assigns(:admin_plan).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_plan as @admin_plan" do
        ...
        Admin::Plan.any_instance.stub(:save).and_return(false)
        post :create, {:admin_plan => {  }}, valid_session
        assigns(:admin_plan).should be_a_new(Admin::Plan)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_plan" do
        plan = Admin::Plan.create! valid_attributes
        # Assuming there are no other admin_plans in the database, this
        # specifies that the Admin::Plan created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Plan.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => plan.to_param, :admin_plan => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_plan as @admin_plan" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Plan.any_instance.stub(:save).and_return(false)
        put :update, {:id => plan.to_param, :admin_plan => {  }}, valid_session
        assigns(:admin_plan).should eq(plan)
      end
